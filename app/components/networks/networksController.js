...
.controller('NetworksController', ['$scope', '$state', 'Network', 'Config', 'Messages', 'Pagination', 'Authentication',
function ($scope, $state, Network, Config, Messages, Pagination, Authentication) {
  $scope.state = {};
